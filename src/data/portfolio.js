import {
    ...
    Github, Linkedin, Mail, ExternalLink, Trophy, Award, Scroll
} from 'lucide-react';
...
export const projects = [
    {
        ...
        image: "/projects/MealZo.png",
        techStack: ["React", "Express.js", "Tailwind CSS", "Jwt-Auth", "Node.js"],
        featured: true,
        liveUrl: "https://mealzo-six.vercel.app/",
        githubUrl: "https://github.com/ayushbajpai21/Mealzo"
    },
    {
        id: 2,
    ...
    },
    {
        id: 3,
        title: "OmniMart",
        description: "OmniMart is a modern all-in-one eCommerce platform designed to deliver a seamless shopping experience. From daily essentials to premium products, we bring quality, convenience, and affordability together in one place.",
        image: "/projects/Omnimart.png",
        techStack: ["React", "Tailwind CSS", "Context API", "Email.js"],
        featured: true,
        liveUrl: "https://omnimart-nine.vercel.app/",
        githubUrl: "https://github.com/ayushbajpai21/omnimart"
    }
];
